    ...
    def detect_targets_polar(polar_scan, background_map=None, min_pts=4, max_pts=80, max_diameter=0.85):
        ...
        for ang, dist_cm, x, y in polar_scan:
            ...
            if background_map is not None:
                ...
                # Tolleranza: distacco di almeno 22 cm dal perimetro registrato
                if bg_dist > 0.35 and (bg_dist - r_m) > 0.22:
        ...
        for cl in clusters:
            ...
            if 0.05 <= max_span <= max_diameter:
                # Analisi PCA: scarta segmenti piatti (pareti residue)
                ...
                if cov.shape == (2, 2):
                    ...
                    # Se il cluster è troppo lineare/piatto (bordo di muro), viene ignorato
