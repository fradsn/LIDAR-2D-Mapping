...
**Active Dynamic Cone Tracking (Closed-Loop Servo Tracking):** Automatically switches from a 360° panoramic scan to a reactive oscillating sector cone ($\pm 15^\circ \div \pm 22^\circ$) centered on moving or static targets. Boosts target telemetry update rates from **0.033 Hz up to 0.75 Hz (over 20x faster)** with smooth kinematic sweeps, directional deadbands ($\ge 4.5^\circ$), and automatic 360° return when toggled off.
...
### 🎯 Active Dynamic Cone Tracking (Closed-Loop Servo Sweep)
*Real-time closed-loop dynamic cone tracking ($\pm 18^\circ$ oscillating sector sweep) locking and following a target:*


https://github.com/user-attachments/assets/0bba0945-a46e-4bd5-b480-aac1c3e7b68b
